# Кросс-задание 2 (fork + poll/epoll/select + timers + IPC)
...
> Механизмы IPC и мультиплексирования, которые нужно использовать при решении этой задачи, задаются преподавателем

> Для решения задачи были использованы механизмы `IPC` - именованные каналы и мультиплексирование с помощью функции `poll`
...
Создадим 3 процесса (driver)

![img2](img/2.png)

Создадим задания, попробуем повторно отправить задания работающему процессу (driver)
