...
Запустим сервер на порту 55555

![img1](img/1.png)

Запустим 2 клиента на портах 55551 и 55552. Отправим сообщения с клиентов

![img2](img/2.png)

При помощи `SIGINT` завершим работу одного из клиентов и перезапустим его

![img3](img/3.png)

Сообщения, полученные сервером
