...
#define DEFAULT_DB_FILE_NAME "db.data"
...
int printMenu() {
    ...
    printf("5) Clear DB\n");
    printf("6) Print DB (tree structure)\n");
    printf("0) Exit\n");
...
int main(int argc, char **argv) {
    ...
    if (argc > 1) {
        ...
        strcpy(filename, DEFAULT_DB_FILE_NAME);
    }
    // open in read-write mode with create flag with rw-r--r-- permissions
